...
RUN chown -R ${NB_UID} ${HOME} && \
 find /usr/lib/python3.9/site-packages/notebook/static \
  -name main.min.js -or -name meta.js -exec sed -i -e \
  '/x-ttcn-asn/s#$#{name: "Ada", mime: "text/x-ada", mode: "ada", ext: ["ads", "adb", "ada"]},#' \
  {} \; && \
 cat /usr/lib/python3.9/site-packages/notebook/static/components/codemirror/mode/ada/ada.js >> \
 /usr/lib/python3.9/site-packages/notebook/static/notebook/js/main.min.js
USER ${NB_USER}
